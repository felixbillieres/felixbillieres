...
{% content-ref url="../../privilege-escalation/windows/impersonation-and-potato-attacks.md" %}
[impersonation-and-potato-attacks.md](../../privilege-escalation/windows/impersonation-and-potato-attacks.md)
{% endcontent-ref %}
...
{% content-ref url="../../../ctf-writeups/active-directory-and-network/sauna.md" %}
[sauna.md](../../../ctf-writeups/active-directory-and-network/sauna.md)
{% endcontent-ref %}
