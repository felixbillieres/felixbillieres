...
<figure><img src="../../../../.gitbook/assets/image.png" alt=""><figcaption><p>We want to use <code>PowerView</code> to enumerate the domain, which requires communication with the Domain Controller, DC01.</p></figcaption></figure>
